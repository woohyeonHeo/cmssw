...
namespace l1t {
  namespace me0 {
    std::vector<std::vector<ME0StubPrimitive>> deghostingClearance(
    ...
    std::tuple<std::vector<ME0StubPrimitive>, Config> processChamber(const std::vector<std::vector<UInt192>>& chamberData,
